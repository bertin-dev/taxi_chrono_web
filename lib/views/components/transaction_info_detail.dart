...
import 'package:taxi_chrono_web/models/transaction_model.dart';
...
class TransactionInfoDetail extends StatelessWidget {
   const TransactionInfoDetail({Key? key, required this.reservation, required this.user,
     required this.transaction, required this.driver}) : super(key: key);

  final Reservation reservation;
  final UserAccount user;
  final TransactionApp transaction;
  final Driver driver;
